...
/**
 * Simple sum of the frequency changes solves part 1
 */
...
/**
 * Iterating through the list over and over looking for a previously 
 * reached frequency solves part 2
 */
function part2(changes) {
    ...
    let index = 0;
    while (true) {
        currentFreq += changes[index++ % changes.length];
